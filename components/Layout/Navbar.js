            ...
            <div className="relative flex items-center justify-between h-16">
                    ...
                    {navigation.map((item) => (
                      ...
                      >
                        <span className={classNames(
                          'cursor-pointer',
                          item.current ? 'text-indigo-500 decoration-2 underline-offset-2 hover:underline hover:decoration-indigo-500' : 'decoration-2 underline-offset-2 hover:underline hover:decoration-indigo-500',
              ...
              <div
                ...
                <Menu as="div" className="ml-3 relative">
                  <div>
                    <Menu.Button
                      className="bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-500 focus:ring-white">
            ...
            <div className="px-2 pt-2 pb-3 space-y-1">
              {navigation.map((item) => (
                ...
                >
                  <span className={classNames(
                    'cursor-pointer',
                    item.current ? 'bg-indigo-500 text-white' : 'hover:bg-indigo-300 hover:text-white',
