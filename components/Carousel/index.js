  ...
  return (
    ...
    <div id="default-carousel" className="relative" data-carousel="slide">
      ...
      <div className="overflow-hidden relative h-56 sm:h-64 xl:h-80 2xl:h-96">
        ...
        <div className="duration-700 ease-in-out absolute inset-0 transition-all transform translate-x-0 z-20 bg-gray-500"
             data-carousel-item="">
          <span
        ...
        <div className="duration-700 ease-in-out absolute inset-0 transition-all transform translate-x-full z-10 bg-gray-500"
             data-carousel-item="">
          <img src="https://www.aboudcar.com/wp-content/uploads/2017/10/GAC_Hyundai-Banner-.jpg"
               className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..." />
        </div>
...
<svg className="w-5 h-5 text-white sm:w-6 sm:h-6 dark:text-gray-800" fill="none" stroke="currentColor"
     viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round"
                                                                  strokeWidth="2" d="M15 19l-7-7 7-7"></path></svg>
...
<svg className="w-5 h-5 text-white sm:w-6 sm:h-6 dark:text-gray-800" fill="none" stroke="currentColor"
     viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round"
                                                                  strokeWidth="2" d="M9 5l7 7-7 7"></path></svg>
